 ...
 */
package com.example.demographdcneo4j.examples.movies.repo;

import com.example.demographdcneo4j.examples.movies.domain.Cinema;
import com.example.demographdcneo4j.examples.movies.domain.CinemaAndBlockbuster;
import com.example.demographdcneo4j.examples.movies.domain.CinemaAndBlockbusterName;
import com.example.demographdcneo4j.examples.movies.domain.queryresult.CinemaQueryResult;
import com.example.demographdcneo4j.examples.movies.domain.queryresult.CinemaQueryResultInterface;
