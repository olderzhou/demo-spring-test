 ...
 */
package com.example.demographdcneo4j.examples.movies.domain.queryresult;

import com.example.demographdcneo4j.examples.movies.domain.Rating;
import com.example.demographdcneo4j.examples.movies.domain.TempMovie;
